...
class WebApp:
    ...
    def _accounts(self) -> str:
        return accounts_html(self.report) + '<h1 class="account-history-title">Histórico de movimientos</h1>' + account_history_html(self.accounts, self.external_cash_movements, self.account_transfers)
