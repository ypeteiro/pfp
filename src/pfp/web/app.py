...
class WebApp:
    ...
    external_cash_movements: tuple = ()
    account_transfers: tuple = ()
    ...
    def _accounts(self) -> str:
        history = f'''<details class="accounts-collapsible accounts-history-collapsible">
<summary><span><strong>Histórico</strong><small>Movimientos externos y traspasos por cuenta</small></span><span class="collapse-chevron" aria-hidden="true">⌄</span></summary>
<div class="accounts-collapsible-content">{account_history_html(self.accounts, self.external_cash_movements, self.account_transfers)}</div>
</details>'''
        return accounts_html(self.report) + history
