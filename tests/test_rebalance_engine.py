...
def build_portfolio():
    ...
    portfolio.positions = {
        "EQUITY": Position(
            symbol="EQUITY", name="Equity ETF", shares=Decimal("10"),
            invested=Decimal("12000"), average_price=Decimal("1200"),
            portfolio_class="EQUITY", market_price=Decimal("1200"),
        ),
        "BOND": Position(
            symbol="BOND", name="Bond ETF", shares=Decimal("10"),
            invested=Decimal("5000"), average_price=Decimal("500"),
            portfolio_class="FIXED_INCOME", market_price=Decimal("500"),
        ),
        "GOLD": Position(
            symbol="GOLD", name="Gold ETF", shares=Decimal("10"),
            invested=Decimal("1000"), average_price=Decimal("100"),
            portfolio_class="GOLD", market_price=Decimal("100"),
        ),
    }
    return portfolio
...
def test_rebalance_splits_large_sale_across_positions():
    ...
    assert [(order.symbol, order.amount, order.shares) for order in sales] == [
        ...
        ("BOND_B", Decimal("1900"), Decimal("19")),
    ]
...
def test_rebalance_excludes_non_rebalanceable_assets_from_target_allocation():
    ...
    portfolio.positions["BTC"] = Position(
        symbol="BTC", name="Bitcoin", shares=Decimal("1"),
